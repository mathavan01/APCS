...
public class main
{
    public static void main(String[] args)
    {
        while(true){
            ...
            while (allAlpha(firstName) == false){
                ...
                if (allAlpha(firstName) == true){
                    break;
                }
            }
            System.out.println("Enter your Last Name: ");
            String lastName = login.nextLine();
            while (allAlpha(lastName) == false){
                ...
                if (allAlpha(lastName) == true){
                    break;
                }
            }
            System.out.println("Enter your Zip Code: ");
            String zipCode = login.nextLine();
            while (isNumString(zipCode) == false){
                ...
                if (isNumString(zipCode) == true){
                    break;
                }
            }
            System.out.println("Enter your Year of Birth: ");
            int birthYear = login.nextInt();
            while (year_of_birth(birthYear) == false){
                ...
                if (year_of_birth(birthYear) == true){
                    break;
                }
            }
            ...
            while (phoneNumber(phoneNum) == false){
                ...
                phoneNum = login.nextLine();
                if (phoneNumber(phoneNum) == true){
                    break;
                }
            }
            System.out.println("Enter your Email: ");
            String email = login.nextLine();
            while (emailAddress(email) == false){
